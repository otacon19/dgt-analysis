...
public class DeselectAllCampaignOperation extends UndoableOperation {
	
	private List<Button> _buttons;
	private ProblemElementsSet _elementsSet;
	
	public DeselectAllCampaignOperation(String label, List<Button> buttons, ProblemElementsSet elementsSet) {
		super(label);
	...
	public IStatus executeOperation(IProgressMonitor monitor, IAdaptable info)
		...
		_elementsSet.notifyCampaignsChanges(new CampaignsChangeEvent(ECampaignsChange.CAMPAIGNS_SELECTED_CHANGES, null, new LinkedList<>(), _inUndoRedo));
