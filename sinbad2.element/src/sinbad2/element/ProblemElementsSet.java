...
public class ProblemElementsSet implements Cloneable {
	...
	public void addMEC(MEC m) {
		...
		notifyMECsChanges(new MECsChangeEvent(EMECsChange.ADD_MEC, null, m, false));
	}
	...
	public void clear() {
		...
		if(!_mecs.isEmpty()) {
			_mecs.clear();
			notifyMECsChanges(new MECsChangeEvent(EMECsChange.MECS_CHANGES, null, _mecs, false));
		}
	}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		result._mecs = new LinkedList<MEC>();
		for(MEC mec: _mecs){
			result._mecs.add((MEC) mec.clone());
		}
